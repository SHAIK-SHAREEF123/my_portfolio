...
import { Moon, Sun, Download, Github, Linkedin, Twitter, Mail, MapPin, ExternalLink, ChevronDown, Code, Database, Globe, Zap, Award, Calendar, Trophy } from 'lucide-react';
...
const Portfolio = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['hero', 'about', 'skills', 'projects', 'achievements', 'education', 'resume', 'contact'];
  ...
  const projects = [
    ...
    },
    {
      ...
      tech: ['Next.js', 'Node.js', 'TypeScript', 'WebContainer', 'mongoDB', 'prisma ORM', 'Redux', 'TailwindCSS', 'ShadCN', 'Open AI API'],
      github: 'https://github.com/SHAIK-SHAREEF123/Vibecode-master',
      image: '/api/placeholder/400/250'
    },
    {
      title: 'CampusPass – Smart Hostel & Outpass Management System',
      description: 'Full-stack campus outpass management system with role-based access, real-time chat, and multi-hostel support to streamline student permissions and improve campus security.',
      tech: ['React', 'Node.js', 'Express.js', 'MongoDB', 'Redux', 'TailwindCSS'],
      github: 'https://github.com/SHAIK-SHAREEF123/campusPass',
      demo: 'https://campus-pass.vercel.app/',
      image: '/api/placeholder/400/250'
    },
    {
      title: 'E-Commerce Store',
      description: 'Full-stack e-commerce web application with product listings, cart and order management, secure authentication, and responsive UI, enabling users to browse, purchase, and manage products seamlessly.',
      tech: ['React', 'Node.js', 'Express', 'TailwindCSS', 'mongoDB', 'Zustand'],
      github: 'https://github.com/SHAIK-SHAREEF123/e-commerce-store',
      demo: 'https://e-commerce-store-zljy.onrender.com/',
      image: '/api/placeholder/400/250'
    },
  ];
  ...
  <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-64 h-0 opacity-0 group-hover:h-72 group-hover:opacity-100 transition-all duration-500 ease-in-out overflow-hidden rounded-xl shadow-lg z-10">
    ...
    />
            ...
            <h1 className={`text-5xl md:text-7xl font-bold mb-6 ${darkMode ? 'text-white' : 'text-gray-900'}`}>
              Hi, I'm <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Shareef</span>
            </h1>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="flex flex-col md:flex-row md:items-center md:gap-16">
            ...
            <figure
              ...
              aria-label="Shareef profile photo"
            >
              ...
              <div className="relative animate-float">
                ...
                <div className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 rounded-full p-[3px] bg-gradient-to-r from-blue-500 via-purple-500 to-blue-600 group-hover:from-blue-400 group-hover:via-purple-400 group-hover:to-pink-500 transition-all duration-500">
                  <img
                    src="/images/SHAREEF.jpg"
                    alt="Shareef smiling in front of a blurred background"
            ...
            <div className="text-center md:text-left flex flex-col justify-center">
              ...
              <div className="animate-slideInUp">
                <h1
                  className={`font-extrabold tracking-tight mb-4 text-3xl sm:text-4xl md:text-5xl lg:text-6xl ${darkMode ? 'text-white' : 'text-gray-900'
                    }`}
                >
                  Hi, I'm{' '}
                ...
                <p
                  className={`text-lg sm:text-xl font-medium mb-5 md:mb-6 ${darkMode ? 'text-gray-300' : 'text-gray-700'
                    }`}
                >
                ...
                <p
                  className={`max-w-xl mb-8 leading-relaxed text-base sm:text-lg md:text-xl ${darkMode ? 'text-gray-400' : 'text-gray-600'
                    }`}
                >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start animate-slideInUp" style={{ animationDelay: '0.3s' }}>
                ...
                >
                  ...
                  <div className={`absolute inset-0 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left ${darkMode ? 'bg-purple-500' : 'bg-purple-600'
                    }`}></div>
                </button>
              </div>
            </div>
              ...
              <div key={category} className={`p-6 rounded-lg ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2`}>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {skillList.map((skill) => (
                    <span
                      key={skill}
                      className={`flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium ${darkMode ? 'bg-gray-700 text-gray-300' : 'bg-gray-100 text-gray-700'
            ...
            <div className={`max-w-4xl mx-auto p-6 md:p-8 rounded-lg ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-lg`}>
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                ...
                <div className="text-right">
                  ...
                  <p className={`text-lg font-semibold ${darkMode ? 'text-green-400' : 'text-green-600'}`}>CGPA: 8.7/10</p>
                </div>
              </div>
            </div>
            ...
            <div className={`max-w-4xl mx-auto p-6 md:p-8 rounded-lg ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-lg`}>
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                ...
                <div className="text-right">
                  ...
                  <p className={`text-lg font-semibold ${darkMode ? 'text-green-400' : 'text-green-600'}`}>CGPA: 9.63/10</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <span className={`${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>shareef.08.2005@gmail.com</span>
                </div>
                <div className="flex items-center gap-4">
                  <MapPin className={`w-6 h-6 ${darkMode ? 'text-blue-400' : 'text-blue-600'}`} />
                  <span className={`${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>Anantapur, Andhra Pradesh, India</span>
                </div>
              </div>
              <div className="flex gap-6 mt-8">
                <a href="https://github.com/SHAIK-SHAREEF123/" target="blank" className={`p-3 rounded-lg ${darkMode ? 'bg-gray-700 text-blue-400 hover:bg-gray-600' : 'bg-gray-100 text-blue-600 hover:bg-gray-200'} transition-all duration-300 hover:-translate-y-1`}>
                  <Github size={24} />
                </a>
                <a href="https://www.linkedin.com/in/shaik-shareef-917620288" target="blank" className={`p-3 rounded-lg ${darkMode ? 'bg-gray-700 text-blue-400 hover:bg-gray-600' : 'bg-gray-100 text-blue-600 hover:bg-gray-200'} transition-all duration-300 hover:-translate-y-1`}>
                  <Linkedin size={24} />
                </a>
